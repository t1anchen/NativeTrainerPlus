...
LPCSTR vehicleModels[40][10] = {
	...
	{"ADDER",       "AIRBUS",       "AIRTUG",        "AKUMA",         "ALPHA",        "AMBULANCE",     "ANNIHILATOR",   "ARMYTANKER",    "ARMYTRAILER",   "ARMYTRAILER2"},
	{"ASEA",        "ASEA2",        "ASTEROPE",      "BAGGER",        "BALETRAILER",  "BALLER",        "BALLER2",       "BALLER3",       "BALLER4",       "BALLER5"},
	{"BALLER6",     "BANSHEE",      "BANSHEE2",      "BARRACKS",      "BARRACKS2",    "BATI",          "BATI2",         "BENSON",        "BESRA",         "BFINJECTION"},
	{"BIFF",        "BIFTA",        "BISON",         "BISON2",        "BISON3",       "BJXL",          "BLADE",         "BLAZER",        "BLAZER2",       "BLAZER3"},
	{"BLIMP",       "BLIMP2",       "BLISTA",        "BLISTA2",       "BLISTA3",      "BMX",           "BOATTRAILER",   "BOBCATXL",      "BODHI2",        "BOXVILLE"},
	{"BOXVILLE2",   "BOXVILLE3",    "BRAWLER",       "BTYPE",         "BTYPE2",       "BTYPE3",        "BUCCANEER",     "BUCCANEER2",    "BUFFALO",       "BUFFALO2"},
	{"BUFFALO3",    "BULLDOZER",    "BULLET",        "BURRITO",       "BURRITO2",     "BURRITO3",      "BURRITO4",      "BURRITO5",      "BUS",           "BUZZARD"},
	{"BUZZARD2",    "CABLECAR",     "CADDY",         "CADDY2",        "CAMPER",       "CARBONIZZARE",  "CARBONRS",      "CARGOBOB",      "CARGOBOB2",     "CARGOBOB3"},
	{"CARGOBOB4",   "CARGOPLANE",   "CASCO",         "CAVALCADE",     "CAVALCADE2",   "CHEETAH",       "CHINO",         "CHINO2",        "COACH",         "COG55"},
	{"COG552",      "COGCABRIO",    "COGNOSCENTI",   "COGNOSCENTI2",  "COMET2",       "COQUETTE",      "COQUETTE2",     "COQUETTE3",     "CRUISER",       "CRUSADER"},
	{"CUBAN800",    "CUTTER",       "DAEMON",        "DILETTANTE",    "DILETTANTE2",  "DINGHY",        "DINGHY2",       "DINGHY4",       "DLOADER",       "DOCKTUG"},
	...
	{"F620",        "FACTION",      "FACTION2",      "FAGGIO2",       "FBI",          "FBI2",          "FELON",         "FELON2",        "FELTZER2",      "FELTZER3"},
	{"FIRETRUK",    "FIXTER",       "FLATBED",       "FORKLIFT",      "FQ2",          "FROGGER",       "FROGGER2",      "FUGITIVE",      "FUROREGT",      "FUSILADE"},
	{"FUTO",        "GAUNTLET",     "GAUNTLET2",     "GBURRITO",      "GLENDALE",     "GRAINTRAILER",  "GRANGER",       "GRESLEY",       "GUARDIAN",      "HABANERO"},
	{"HAKUCHOU",    "HANDLER",      "HAULER",        "HEXER",         "HOTKNIFE",     "HUNTLEY",       "HYDRA",         "INFERNUS",      "INGOT",         "INNOVATION"},
	{"INSURGENT",   "INSURGENT2",   "INTRUDER",      "ISSI2",         "JACKAL",       "JB700",         "JESTER",        "JESTER2",       "JET",           "JETMAX"},
	{"JOURNEY",     "KALAHARI",     "KHAMELION",     "KURUMA",        "KURUMA2",      "LANDSTALKER",   "LAZER",         "LECTRO",        "LGUARD",        "LIMO2"},
	{"LURCHER",     "LUXOR",        "LUXOR2",        "MAMBA",         "MAMMATUS",     "MANANA",        "MARQUIS",       "MARSHALL",      "MASSACRO",      "MASSACRO2"},
	{"MAVERICK",    "MESA",         "MESA2",         "MESA3",         "MILJET",       "MINIVAN",       "MIXER",         "MIXER2",        "MONROE",        "MONSTER"},
	{"MOONBEAM",    "MOONBEAM2",    "MOWER",         "MULE",          "MULE2",        "NEMESIS",       "NIGHTSHADE",    "NINEF",         "NINEF2",        "ORACLE"},
	{"ORACLE2",     "OSIRIS",       "PACKER",        "PANTO",         "PARADISE",     "PATRIOT",       "PBUS",          "PCJ",           "PENUMBRA",      "PEYOTE"},
	{"PHANTOM",     "PHOENIX",      "PICADOR",       "PIGALLE",       "POLICE",       "POLICE2",       "POLICE3",       "POLICE4",       "POLICEB",       "POLICEOLD1"},
	{"POLICEOLD2",  "POLICET",      "POLMAV",        "PONY",          "PONY2",        "POUNDER",       "PRAIRIE",       "PRANGER",       "PREDATOR",      "PREMIER"},
	{"PRIMO",       "PRIMO2",       "PROPTRAILER",   "RADI",          "RAKETRAILER",  "RANCHERXL",     "RANCHERXL2",    "RAPIDGT",       "RAPIDGT2",      "RATLOADER"},
	{"RATLOADER2",  "REBEL",        "REBEL2",        "REGINA",        "RENTALBUS",    "RHAPSODY",      "RHINO",         "RIOT",          "RIPLEY",        "ROCOTO"},
	{"ROMERO",      "RUBBLE",       "RUFFIAN",       "RUINER",        "RUMPO",        "RUMPO2",        "SABREGT",       "SADLER",        "SADLER2",       "SANCHEZ"},
	{"SANCHEZ2",    "SANDKING",     "SANDKING2",     "SAVAGE",        "SCHAFTER2",    "SCHAFTER3",     "SCHAFTER4",     "SCHAFTER5",     "SCHAFTER6",     "SCHWARZER"},
	{"SCORCHER",    "SCRAP",        "SEASHARK",      "SEASHARK2",     "SEASHARK3",    "SEMINOLE",      "SENTINEL",      "SENTINEL2",     "SERRANO",       "SHAMAL"},
	{"SHERIFF",     "SHERIFF2",     "SKYLIFT",       "SLAMVAN",       "SLAMVAN2",     "SOVEREIGN",     "SPEEDER",       "SPEEDER2",      "SPEEDO",        "SPEEDO2"},
	{"SQUALO",      "STALION",      "STALION2",      "STANIER",       "STINGER",      "STINGERGT",     "STOCKADE",      "STOCKADE3",     "STRATUM",       "STRETCH"},
	{"STUNT",       "SUBMERSIBLE",  "SUBMERSIBLE2",  "SULTAN",        "SULTANRS",     "SUNTRAP",       "SUPERD",        "SUPERVOLITO",   "SUPERVOLITO2",  "SURANO"},
	{"SURFER",      "SURFER2",      "SURGE",         "SWIFT",         "SWIFT2",       "T20",           "TACO",          "TAILGATER",     "TAMPA",         "TANKER"},
	{"TAXI",        "TECHNICAL",    "THRUST",        "TIPTRUCK",      "TIPTRUCK2",    "TITAN",         "TORNADO",       "TORNADO2",      "TORNADO3",      "TORNADO4"},
	{"TORO",        "TORO2",        "TOURBUS",       "TOWTRUCK",      "TOWTRUCK2",    "TR2",           "TR3",           "TR4",           "TRACTOR",       "TRACTOR2"},
	{"TRACTOR3",    "TRAILERLOGS",  "TRAILERS",      "TRAILERS2",     "TRAILERS3",    "TRAILERSMALL",  "TRASH",         "TRFLAT",        "TRIBIKE",       "TRIBIKE2"},
	{"TRIBIKE3",    "TROPIC",       "TROPIC2",       "TURISMOR",      "TVTRAILER",    "UTILLITRUCK",   "UTILLITRUCK2",  "UTILLITRUCK3",  "VACCA",         "VADER"},
	{"VALKYRIE",    "VALKYRIE2",    "VELUM",         "VELUM2",        "VERLIERER2",   "VESTRA",        "VIGERO",        "VINDICATOR",    "VIRGO",         "VOLTIC"},
	{"VOODOO",      "VOODOO2",      "WARRENER",      "WASHINGTON",    "WINDSOR",      "YOUGA",         "ZENTORNO",      "ZION",          "ZION2",         "ZTYPE"},
};
